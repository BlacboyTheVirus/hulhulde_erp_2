...
@section('title', 'Production Outputs | Dashboard')
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div id="errorBox"></div>
            <div class="col-md-6">
                <form method="POST" action="{{route('production.output.store')}}" id="newform">
                    @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3 col-sm-3 border-right">
                                    <div class="description-block">
                                        ...
                                        <h5 class="description-header" id="paddy_weight">{{$data['weight']}}</h5>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-3 ">
                                    <div class="description-block">
                                        ...
                                        <h5 class="description-header">{{$data['production_date']}}</h5>
                                    </div>
                ...
                $.ajax({
                    ...
                    success:  function (response) {
                        if (response.success){
                            ...
                            setTimeout(() => {
                                window.location.href = '{{route('production.output.index')}}';
                            }, 1000);
                        } else {
