                            ...
                            <div class="row">
                                ...
                                <div class="card-tools">
                                    <div class="btn-group ">
                                        ...
                                        <a href="{{ route('production.create') }}" class="btn btn-success" > <i class="fa fa-cart-plus nav-icon"></i> Create New</a>
                                    </div>
                            ...
                            <table id="tblData" class="table table-hover dataTable dt-responsive  dtr-inline">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="exportable">Output Weight</th>
        ...
        $(document).ready(function(){
            ...
            var table = $('#tblData').DataTable({
                ...
                columns:[
                    ...
                    {data:'output_weight', name:'output_weight'},
